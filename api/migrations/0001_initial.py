    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_ratings', models.ManyToManyField(related_name='age_ratings', to='api.agerating')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('support_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='support_type', to='api.supporttype')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='game',
            name='game_modes',
            field=models.ManyToManyField(related_name='game_modes', to='api.gamemodes'),
        ),
        migrations.AddField(
            model_name='game',
            name='genres',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='alternative_titles', to='api.game')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.AddField(
            model_name='game',
            name='cover',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cover', to='api.cover'),
        ),
        migrations.AddField(
            model_name='cover',
            name='locale_cover',
